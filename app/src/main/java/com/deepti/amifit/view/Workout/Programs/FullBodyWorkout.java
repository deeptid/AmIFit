...
public class FullBodyWorkout extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        ScrollView layout = (ScrollView) inflater.inflate(R.layout.fullbody_program, container, false);
        ...
        final String[] fullBodyPrograms = getResources().getStringArray(R.array.fullbody_program);
        ...
        iv1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setData(Uri.parse("https://www.youtube.com/watch?v=1Pc-NizMgg8"));
        ...
        iv2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://www.youtube.com/watch?v=ZEz0VGxsiqc"));
                startActivity(intent);
            }
        });
        ...
        iv3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://www.izlesene.com/video/jillian-michaels-30-day-shred-level-3/7259991"));
                startActivity(intent);
            }
        });
